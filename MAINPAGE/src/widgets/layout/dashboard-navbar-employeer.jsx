...
export function DashboardNavbarEmployer() {
    ...
    >
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        ...
        <Typography
                variant="small"
                color="blue-gray"
              className="text-primary font-bold pl-10"
                >
...
DashboardNavbarEmployer.displayName = "/src/widgets/layout/dashboard-navbar.jsx";

export default DashboardNavbarEmployer;